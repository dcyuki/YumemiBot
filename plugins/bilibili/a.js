...
const { getConfig, setConfig, scheduleJob } = require(`${__yumemi}/utils/util`);
const mid = new Map();

mid.set('pcr_bl', 353840826);
mid.set('pcr_jp', 484884957);
      ...
      biliAPI({ mid }, ['dynamics'])
        .then(data => {
          ...
          switch (type) {
            ...
            default:
              msg = null;
              bot.logger.mark(`检测到动态更新，但为转发或投稿动态，不会推送`);
              break;
          }
