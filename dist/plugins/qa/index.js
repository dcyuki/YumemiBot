...
function qa(bot, data) {
    ...
    class_1.checkCommand(raw_message, qa.answer) && answer(data);
    class_1.checkCommand(raw_message, qa.question) && question(data);
    class_1.checkCommand(raw_message, qa.select) && select(data);
}
