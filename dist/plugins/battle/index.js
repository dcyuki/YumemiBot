...
async function insertBattle(bot, data) {
    ...
    const { battle: { version } } = groups[group_id].settings;
    const level = await class_1.getLevel(bot, data);
    if (level < 3)
...
async function battle(bot, data) {
    ...
    class_1.checkCommand(raw_message, battle.insertBattle) && insertBattle(bot, data);
    class_1.checkCommand(raw_message, battle.initGuild) && initGuild(bot, data);
    class_1.checkCommand(raw_message, battle.insertBeat) && insertBeat(bot, data);
    class_1.checkCommand(raw_message, battle.replace) && replace(bot, data);
    class_1.checkCommand(raw_message, battle.deleteBattle) && deleteBattle(bot, data);
    // checkCommand(raw_message, battle.updateBeat) && updateBeat(bot, data);
    class_1.checkCommand(raw_message, battle.updateBossInfo) && updateBossInfo(bot, data);
    class_1.checkCommand(raw_message, battle.reservation) && reservation(bot, data);
    class_1.checkCommand(raw_message, battle.selectBattle) && selectBattle(bot, data);
    class_1.checkCommand(raw_message, battle.selectBeat) && selectBeat(bot, data);
    class_1.checkCommand(raw_message, battle.deleteBeat) && deleteBeat(bot, data);
    class_1.checkCommand(raw_message, battle.score) && score(bot, data);
    class_1.checkCommand(raw_message, battle.rank) && rank(bot, data);
    class_1.checkCommand(raw_message, battle.rescind) && rescind(bot, data);
}
