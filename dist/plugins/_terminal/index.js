...
function terminal(bot, data) {
    ...
    const { raw_message } = data;
    class_1.checkCommand(raw_message, _terminal.update) && update(bot, data);
    class_1.checkCommand(raw_message, _terminal.state) && state(data);
    class_1.checkCommand(raw_message, _terminal.sugar) && sugar(bot, data);
    class_1.checkCommand(raw_message, _terminal.control) && control(bot, data);
    class_1.checkCommand(raw_message, _terminal.list) && list(bot, data);
    class_1.checkCommand(raw_message, _terminal.setting) && setting(bot, data);
    class_1.checkCommand(raw_message, _terminal.lock) && lock(bot, data);
}
